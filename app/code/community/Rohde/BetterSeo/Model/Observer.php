...
class Rohde_Seo_Model_Observer
{
    ...
    public function alternateLinks() {
        ...
        if(Mage::getStoreConfig("rohde/betterseo/enable_module") != false) {
            ...
            if($headBlock) {
                ...
                foreach ($stores as $store) {
                    ...
                    if(Mage::getStoreConfig("rohde/betterseo/hreflang_value") == 'language') {
                        // Strips locale string down to th first 2 characters - matching the ISO 639-1 format
                        $lang = substr($lang, 0, 2);
                    } elseif(Mage::getStoreConfig("rohde/betterseo/hreflang_value") == 'language-region') {
